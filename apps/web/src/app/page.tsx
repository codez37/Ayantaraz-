...
const services = [
  ...
  { icon: '🤖', title: 'پرسش و پاسخ مالیاتی', desc: 'پاسخگویی آنلاین به سوالات شما بر اساس قوانین مالیاتی' },
];

export const metadata: Metadata = {
  title: 'آیان تراز | خدمات حسابداری و مشاوره مالیاتی حرفه‌ای',
  description: 'ارائه خدمات حسابداری، مشاوره مالیاتی، آموزش مالی و سامانه پرسش و پاسخ برای کسب‌وکارها و اشخاص',
  alternates: {
    canonical: SITE_URL,
  },
  openGraph: {
    title: 'آیان تراز | خدمات حسابداری و مشاوره مالیاتی',
    description: 'ارائه خدمات حسابداری، مشاوره مالیاتی، آموزش مالی و سامانه پرسش و پاسخ مالیاتی',
    url: SITE_URL,
    siteName: 'آیان تراز',
    images: [
      {
      ...
      <section className="container-mobile py-20 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/tax-consultant" className="btn-outline-gold text-lg">پرسش و پاسخ مالیاتی</Link>
          </div>
        </div>
      </section>
        ...
        <div className="container-mobile max-w-3xl">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: 'چگونه می‌توانم درخواست مشاوره بدهم؟', a: 'از صفحه مشاوره فرم را پر کنید یا از سامانه پرسش و پاسخ مالیاتی استفاده کنید. کارشناسان ما با شما تماس می‌گیرند.' },
              ...
              { q: 'هزینه مشاوره چقدر است؟', a: 'هزینه بستگی به نوع و مدت مشاوره دارد. برای اطلاع دقیق با ما تماس بگیرید یا از سامانه پرسش و پاسخ استفاده کنید.' },
            ].map((item, i) => (
